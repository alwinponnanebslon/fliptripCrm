...
import { addNoteApi, getNotesApi, NoteDeleteApi, updateNoteApi } from "../../../Services/note.service";
...
export const addnote = createAsyncThunk("note/addnote", async (payload, thunkApi) => {
  try {
...
export const updatenote = createAsyncThunk("note/updatenote", async (formData, thunkApi) => {
  try {
