...
import { clientAdd,clientUpdate } from '../../redux/features/client/clientSlice';
      ...
      <div className="modal-content">
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="submit-section">
              <button className="btn btn-primary submit-btn" ttype="submit"  >{clientId ? "Update":"Add"}</button>
            </div>
          </form>
        </div>
      </div>
