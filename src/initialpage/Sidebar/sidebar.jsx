          ...
          <div className="sidebar-inner slimscroll">
            <div id="sidebar-menu" className="sidebar-menu">
              <ul>
                    ...
                    <ul>
                      <li>
                        <Link
                          ...
                          to="/admin/employee/allemployees"
                        >
                          All Employees
                        </Link>
                      </li>
                ...
                <li className={pathname?.includes("clients") ? "active" : ""}>
                  <Link to="/admin/employees/clients">
                    <i className="la la-users" /> <span>Clients</span>
                  </Link>
                </li>
                ...
                { pathname?.includes("lead-view") && (
                    ...
                    <>
                        <li className="menu-title">
                          <Link to="/admin/employees/leads" className="active" ><i className="fa fa-back-arrow"></i>  Back</Link>
                          </li>

                     <li
                  className={pathname?.includes("create-quote") ? "active" : ""}
                >
                  <Link to="/admin/employees/create-quote">
